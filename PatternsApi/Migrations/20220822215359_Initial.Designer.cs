...
namespace PatternsApi.Migrations
{
    ...
    [Migration("20220822215359_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatternsApi.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatternsApi.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatternsApi.Models.Cover", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatternsApi.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseTags", b =>
                {
                    b.HasOne("PatternsApi.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatternsApi.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PatternsApi.Models.Course", b =>
                {
                    b.HasOne("PatternsApi.Models.Author", "Author")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("PatternsApi.Models.Cover", b =>
                {
                    b.HasOne("PatternsApi.Models.Course", "Course")
                        .WithOne("Cover")
                        .HasForeignKey("PatternsApi.Models.Cover", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
