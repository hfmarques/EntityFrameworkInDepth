...
namespace Queries.Migrations
{
    ...
    [Migration("20220819212203_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Queries.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Queries.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Queries.Models.Cover", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Queries.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseTags", b =>
                {
                    b.HasOne("Queries.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Queries.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Queries.Models.Course", b =>
                {
                    b.HasOne("Queries.Models.Author", "Author")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Queries.Models.Cover", b =>
                {
                    b.HasOne("Queries.Models.Course", "Course")
                        .WithOne("Cover")
                        .HasForeignKey("Queries.Models.Cover", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
